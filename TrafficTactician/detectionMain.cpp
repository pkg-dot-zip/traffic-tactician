...
void getCalculatedPose(cv::Mat& input, cv::Mat& outputFrame, cv::dnn::Net& inputNet)
{
...
static std::string getDirectionString(PoseDirection pose_direction)
{
...
int main(int argc, char** argv)
{
	...
	while (true)
	{
		...
		getCalculatedPose(input, outputFrame, inputNet);
